...
def fetch_list(site, index, company, file_path):
    ...
    try:
        ...
        if 'Importers' in tabs.text:
            driver.find_element(By.XPATH,"//*[@id='company-profile']/div/div[3]/div/nav/ul/li[3]/a").click()
...
def process2(company):
    sheet=company.replace(" ",'')
    file_path=sheet+'importers'+'.xlsx'
    ...
    update_sheet(existing_workbook_path=file_path, sheet_name_to_copy='IG_importers')
    os.unlink(file_path)
